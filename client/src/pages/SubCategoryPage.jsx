...
const SubCategoryPage = () => {
  ...
  const handleDeleteSubCategory= async ()=>{
    try {
      //console.log("Deletando:", deleteSubCategory); // debug
  ...
  return (
    <section className="category-page">
      <div className="p-2 bg-white shadow-md flex items-center justify-between">
        <h2 className="font-semibold">Cadastrar Sub_Categoria</h2>
        <button
          onClick={() => setOpenAddSubCategory(true)}
          className="text-sm font-bold text-white min-w-20 border border-red-600 hover:border-green-600 
          hover:bg-yellow-600 px-3 py-1 rounded-full mt-3 bg-gradient-to-r from-red-600 via-orange-500 to-yellow-600"
        >
